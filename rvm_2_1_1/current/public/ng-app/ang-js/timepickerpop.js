...
.directive('timepickerPop', function($document, timepickerState) {
      return {
        ...
        template : "<input type='text' class='form-control form-input-timer' ng-model='inputTime' ng-disabled='disabledInt' time-format show-meridian='showMeridian' ng-focus='open()' />"
            + "  <div class='input-group-btn' ng-class='{open:isOpen}'> "
            + "   <div class='fa fa-clock-o' ng-disabled='disabledInt' class='btn btn-default ' ng-class=\"{'btn-primary':isOpen}\" data-toggle='dropdown' ng-click='toggle()'></div>"
